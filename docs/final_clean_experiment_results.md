...
- **GitHub (published):** `results/combined_metrics/summary_by_model_by_eval_subset_CORRECTED.csv`
- **Local full dump:** `outputs/evaluation/final_clean_full_curated_v1/combined_metrics/summary_by_model_by_eval_subset_CORRECTED.csv`
...
**Main conclusion — recall vs. selectivity tradeoff:**
